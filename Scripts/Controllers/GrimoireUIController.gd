...
@onready var pages_showcase: HBoxContainer = $VBoxContainer/HBoxContainer/PanelContainer/MarginContainer/PageVBox/PageScrollContainer/MarginContainer/PagesShowcase
